    ...
    <div className={styles.container}>
      <header className={styles.header}>
        <div className={styles.logo}>
          <Image src="/image/logo.png" alt="PeTA Logo" width={50} height={50} />
        </div>
        <div className={styles.nav}>
          <button className={styles.signUpBtn}>
            <motion.a href="/signup">SIGN UP</motion.a>
          </button>
          <button className={styles.loginBtn}>
            <motion.a href="/login"> LOGIN</motion.a>
          </button>
        </div>
      </header>
      ...
      <main className={styles.main}>
        ...
        <section className={styles.heroSection} id="hero">
          ...
          <div className={styles.heroContent}>
            <h1 className={styles.title}>
              Pantau Pertumbuhan
              <br />
              Anak Dengan <span>PeTA</span>
            </h1>
            <p className={styles.description}>
              Melalui fitur pemantauan gizi dan rekomendasi resep harian, PeTA
              membantu orang tua dalam menyediakan asupan nutrisi terbaik bagi
              anak untuk standar kesehatan, sehingga pertumbuhan si kecil dapat
              berjalan optimal dan terhindar dari risiko stunting.
            </p>
        ...
        <section className={styles.stuntingSection} id="stunting">
          ...
          <div className={styles.stuntingContent}>
            ...
            <div className={styles.stuntingInfo}>
              <h2>Stunting?</h2>
              <p>
                Stunting adalah gangguan pertumbuhan akibat kekurangan gizi
                kronis sejak dalam kandungan hingga awal kehidupan anak, yang
                baru terlihat jelas setelah usia dua tahun. Kondisi ini tidak
                hanya menyebabkan hambatan pertumbuhan fisik, tetapi juga
                mengganggu perkembangan otak, menurunkan kecerdasan, dan
                berdampak jangka panjang pada produktivitas di masa dewasa.
                Menurut data pada 1.000 Hari Pertama Kehidupan, ini merupakan
                ancaman serius bagi kualitas generasi mendatang.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.preventionSection} id="prevention">
          ...
          <div className={styles.preventionWrapper}>
            ...
            <p>
              PeTA (Pemantau Tumbuh Anak) adalah aplikasi web yang membantu
              orang tua memantau pertumbuhan dan asupan gizi anak untuk mencegah
              stunting. PeTA menyediakan rekomendasi menu sesuai usia dan
              kebutuhan nutrisi anak, serta memberi notifikasi jika asupan
              harian belum tercukupi. Dengan fitur ini, PeTA mendukung tumbuh
              kembang anak secara optimal melalui pemantauan dan edukasi gizi
              terbaik.
            </p>
          </div>
        </section>
